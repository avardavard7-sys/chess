      ...
      <main className="pt-24 pb-12 px-4">
        <div className="max-w-3xl mx-auto">
          <motion.div className="text-center mb-6" initial={{ opacity: 0, y: -15 }} animate={{ opacity: 1, y: 0 }}>
            <h1 className="text-3xl font-bold mb-2" style={{ fontFamily: "'Playfair Display', serif", color: '#f59e0b' }}>{t('leaderboard_title')}</h1>
            <p className="text-white/50 text-sm">{t('best_players')}</p>
          </motion.div>
          ...
          <div className="glass rounded-2xl overflow-hidden">
            ...
            {sorted.length === 0 && <div className="p-10 text-center text-white/30">{t('no_players')}</div>}
          </div>
        </div>
      </main>
    </div>
