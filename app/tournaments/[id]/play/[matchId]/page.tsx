        ...
        <div className="max-w-5xl mx-auto">
          ...
          <motion.div className="glass p-4 rounded-xl mb-4 flex items-center gap-4"
            ...
            <div className="flex-1">
              ...
              <div className="text-xs text-white/30">{t('round_label')} {match.round_number} | {tournament?.time_control}</div>
            </div>
          ...
          {waiting && !gameStarted && (
            <motion.div className="glass p-10 rounded-2xl text-center"
              ...
              <p className="text-white/20 text-xs">{t('game_starts_auto')}</p>
            </motion.div>
          )}
          ...
          {gameOver && (
            <motion.div className="glass p-10 rounded-2xl text-center"
              ...
              <p className="text-white/40 text-sm mb-4">{t('result_recorded')}</p>
              <p className="text-white/20 text-xs">{t('return_tournament')}</p>
