      ...
      <main className="pt-24 pb-12 px-4">
        <div className="max-w-4xl mx-auto">
          <motion.div className="text-center mb-8" initial={{ opacity: 0, y: -15 }} animate={{ opacity: 1, y: 0 }}>
            ...
            <p className="text-white/50">Смотрите партии в реальном времени</p>
          </motion.div>
          ...
          {loading ? (
            ...
            <motion.div className="glass p-10 rounded-2xl text-center" initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <p className="text-white/40">Сейчас никто не играет</p>
              <p className="text-white/20 text-sm mt-2">Когда кто-то начнёт партию — она появится здесь</p>
            </motion.div>
          ) : (
