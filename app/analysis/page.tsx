      ...
      <div className="min-h-screen">
        ...
        <div className="flex items-center justify-center min-h-screen pt-24 px-4">
          <motion.div className="glass p-10 rounded-2xl text-center max-w-md w-full" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
            ...
            <h2 className="text-3xl font-bold mb-3" style={{ fontFamily: "'Playfair Display', serif", color: '#f59e0b' }}>{t('analysis_title')}</h2>
        ...
        <div className="max-w-3xl mx-auto">
          <motion.div className="flex items-center justify-between mb-8" initial={{ opacity: 0, y: -15 }} animate={{ opacity: 1, y: 0 }}>
            <div>
              ...
              <p className="text-white/40 text-sm mt-1">{t("analysis_title")}</p>
            </div>
          </motion.div>
          ...
          {games.length === 0 ? (
            <motion.div className="glass p-10 rounded-2xl text-center" initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <h3 className="text-xl font-bold mb-2" style={{ fontFamily: "'Playfair Display', serif" }}>{t('no_games_yet')}</h3>
              <p className="text-white/40 text-sm mb-6">{t('no_games_play')}</p>
              <motion.button
                onClick={() => router.push('/')}
                      ...
                      <div className="flex-shrink-0 text-right">
                        {hasAnalysis && playerAccuracy != null ? (
                          <div>
                            ...
                            <div className="text-xs text-white/30">{t('accuracy_label')}</div>
                          </div>
                        ) : hasMoves ? (
                          <div
                          ...
                          <div className="text-xs text-white/20">{t('no_data')}</div>
                        )}
                      </div>
                    </div>
                  </motion.div>
