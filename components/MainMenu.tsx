      ...
      >
        ...
        <motion.div className="mt-4 max-w-2xl mx-auto"
          ...
          <motion.button onClick={() => router.push('/rating')}
            ...
            <span className="text-3xl relative z-10">{'📊'}</span>
            <div className="relative z-10">
              <h3 className="text-base font-bold text-white" style={{ fontFamily: "'Playfair Display', serif" }}>Внутренний рейтинг</h3>
              <p className="text-xs text-white/50 mt-0.5">Баллы и разряды учеников школы</p>
            </div>
            <span className="ml-auto text-white/20 group-hover:text-white/50 transition-colors relative z-10">{'>'}</span>
          </motion.button>
        </motion.div>
        ...
        <motion.div className="mt-4 max-w-2xl mx-auto"
          ...
          <motion.button onClick={() => router.push('/shop')}
            ...
            <div className="relative z-10">
              <h3 className="text-base font-bold text-white" style={{ fontFamily: "'Playfair Display', serif" }}>Магазин</h3>
              <p className="text-xs text-white/50 mt-0.5">Обменяй коины на призы!</p>
            </div>
            <span className="ml-auto text-white/20 group-hover:text-white/50 transition-colors relative z-10">{'>'}</span>
          </motion.button>
        </motion.div>
