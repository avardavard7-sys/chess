    ...
    <div className="min-h-screen pt-24 pb-12 px-4">
      ...
      >
        ...
        >
          {difficulties.map((diff) => (
            ...
            >
              ...
              >
                {({'kids': t('diff_kids'), 'beginner': t('diff_beginner_full'), 'medium': t('diff_medium_full'), 'hard': t('diff_hard_full'), 'expert': t('diff_expert_full')}[diff.id] || diff.title)}
              </h2>
        ...
        >
          ...
          >
            ...
            <div className="relative z-10">
              <h3 className="text-base font-bold text-white" style={{ fontFamily: "'Playfair Display', serif" }}>{t('menu_learn')}</h3>
              <p className="text-xs text-white/50 mt-0.5">{t('menu_learn_desc')}</p>
            </div>
          ...
          >
            ...
            <div className="relative z-10">
              <h3 className="text-base font-bold text-white" style={{ fontFamily: "'Playfair Display', serif" }}>{t('menu_ai_train')}</h3>
              <p className="text-xs text-white/50 mt-0.5">{t('menu_train_desc')}</p>
            </div>
            <span className="ml-auto text-white/20 group-hover:text-white/50 transition-colors relative z-10">→</span>
          </motion.button>
          ...
          >
            ...
            <div className="relative z-10">
              <h3 className="text-base font-bold text-white" style={{ fontFamily: "'Playfair Display', serif" }}>{t('menu_analysis')}</h3>
              <p className="text-xs text-white/50 mt-0.5">{t('menu_analysis_desc')}</p>
            </div>
            <span className="ml-auto text-white/20 group-hover:text-white/50 transition-colors relative z-10">→</span>
          </motion.button>
          ...
          <motion.button onClick={() => router.push('/tournaments')}
            ...
            <motion.span className="text-4xl relative z-10" animate={{ y: [0, -4, 0] }} transition={{ duration: 3, repeat: Infinity }}>{'🏆'}</motion.span>
            <div className="relative z-10">
              <h3 className="text-base font-bold text-white" style={{ fontFamily: "'Playfair Display', serif" }}>{t('menu_tournaments')}</h3>
              <p className="text-xs text-white/50 mt-0.5">{t('menu_tournaments_desc')}</p>
            </div>
            <span className="ml-auto text-white/20 group-hover:text-white/50 transition-colors relative z-10">→</span>
          </motion.button>
        </motion.div>
        ...
        <motion.div className="mt-4 max-w-2xl mx-auto"
          ...
          <motion.button onClick={() => router.push('/national-rating')}
            className="relative w-full flex items-center gap-4 p-5 rounded-2xl cursor-pointer overflow-hidden group text-left"
            style={{ background: 'linear-gradient(135deg, rgba(26,143,227,0.12), rgba(255,215,0,0.08))', border: '1px solid rgba(255,215,0,0.35)', backdropFilter: 'blur(12px)' }}
            whileHover={{ scale: 1.03, boxShadow: '0 15px 40px rgba(255,215,0,0.25)', y: -3 }} whileTap={{ scale: 0.97 }}>
            <motion.span className="text-4xl relative z-10" animate={{ rotate: [0, 5, -5, 0] }} transition={{ duration: 4, repeat: Infinity }}>🇰🇿</motion.span>
            <div className="relative z-10">
              <h3 className="text-base font-bold" style={{ fontFamily: "'Playfair Display', serif", color: '#ffd700' }}>Национальный рейтинг</h3>
              <p className="text-xs text-white/60 mt-0.5">Рейтинг шахматистов Казахстана</p>
            </div>
            <span className="ml-auto text-white/20 group-hover:text-white/50 transition-colors relative z-10">→</span>
          </motion.button>
        </motion.div>
        ...
        <motion.div className="mt-4 max-w-2xl mx-auto"
          ...
          <motion.button onClick={() => router.push('/payment')}
            className="relative w-full flex items-center gap-4 p-5 rounded-2xl cursor-pointer overflow-hidden group text-left"
            style={{ background: 'linear-gradient(135deg, rgba(220,38,38,0.15), rgba(245,158,11,0.08))', border: '1px solid rgba(245,158,11,0.35)', backdropFilter: 'blur(12px)' }}
            whileHover={{ scale: 1.03, boxShadow: '0 15px 40px rgba(245,158,11,0.25)', y: -3 }} whileTap={{ scale: 0.97 }}>
            <motion.span className="text-4xl relative z-10" animate={{ scale: [1, 1.08, 1] }} transition={{ duration: 2.5, repeat: Infinity }}>💳</motion.span>
            <div className="relative z-10 flex-1">
              <h3 className="text-base font-bold" style={{ fontFamily: "'Playfair Display', serif", color: '#fbbf24' }}>Оплата услуг</h3>
              <p className="text-xs text-white/60 mt-0.5">Kaspi QR или ссылка — оплатите занятия в один клик</p>
            </div>
            <span className="ml-auto text-white/20 group-hover:text-white/50 transition-colors relative z-10">→</span>
          </motion.button>
        </motion.div>
        ...
        <motion.div className="mt-4 max-w-2xl mx-auto"
          ...
          <motion.button onClick={() => router.push('/leaderboard')}
            ...
            <div className="relative z-10">
              <h3 className="text-base font-bold text-white" style={{ fontFamily: "'Playfair Display', serif" }}>{t('menu_leaderboard_title')}</h3>
              <p className="text-xs text-white/50 mt-0.5">{t('menu_top_players')}</p>
            </div>
            <span className="ml-auto text-white/20 group-hover:text-white/50 transition-colors relative z-10">{'>'}</span>
          </motion.button>
        </motion.div>
        ...
        <motion.div className="mt-4 max-w-2xl mx-auto"
          ...
          <motion.button onClick={() => router.push('/rating')}
            className="relative w-full flex items-center gap-4 p-5 rounded-2xl cursor-pointer overflow-hidden group text-left"
            style={{ background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(139,92,246,0.3)', backdropFilter: 'blur(12px)' }}
            whileHover={{ scale: 1.03, y: -3 }} whileTap={{ scale: 0.97 }}>
            <span className="text-3xl relative z-10">{'📊'}</span>
            <div className="relative z-10">
              <h3 className="text-base font-bold text-white" style={{ fontFamily: "'Playfair Display', serif" }}>{t('menu_internal_rating')}</h3>
              <p className="text-xs text-white/50 mt-0.5">{t('menu_internal_desc')}</p>
            </div>
            <span className="ml-auto text-white/20 group-hover:text-white/50 transition-colors relative z-10">{'>'}</span>
          </motion.button>
        </motion.div>
        ...
        <motion.div className="mt-4 max-w-2xl mx-auto"
          ...
          <motion.button onClick={() => router.push('/watch')}
            ...
            <div className="relative z-10">
              <h3 className="text-base font-bold text-white" style={{ fontFamily: "'Playfair Display', serif" }}>{t('menu_now_playing')}</h3>
              <p className="text-xs text-white/50 mt-0.5">{t('menu_watch_desc')}</p>
            </div>
            <span className="ml-auto text-white/20 group-hover:text-white/50 transition-colors relative z-10">{'>'}</span>
          </motion.button>
        </motion.div>
        ...
        <motion.div className="mt-4 max-w-2xl mx-auto"
          ...
          <motion.button onClick={() => router.push('/shop')}
            className="relative w-full flex items-center gap-4 p-5 rounded-2xl cursor-pointer overflow-hidden group text-left"
            style={{ background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(234,179,8,0.3)', backdropFilter: 'blur(12px)' }}
            whileHover={{ scale: 1.03, y: -3 }} whileTap={{ scale: 0.97 }}>
            <span className="text-3xl relative z-10">{'🛍️'}</span>
            <div className="relative z-10">
              <h3 className="text-base font-bold text-white" style={{ fontFamily: "'Playfair Display', serif" }}>{t('menu_shop')}</h3>
              <p className="text-xs text-white/50 mt-0.5">{t('menu_shop_coins')}</p>
            </div>
            <span className="ml-auto text-white/20 group-hover:text-white/50 transition-colors relative z-10">{'>'}</span>
          </motion.button>
        </motion.div>
