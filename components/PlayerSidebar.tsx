            ...
            {loading ? (
              ...
              <div className="flex-1 flex flex-col">
                ...
                <div className="p-3 space-y-1">
                  ...
                  <Link href="/admin" onClick={onClose} className="flex items-center gap-3 px-4 py-3 rounded-xl text-white/40 hover:bg-white/5 hover:text-white/60 transition-all border-t border-white/5 mt-2 pt-3">
